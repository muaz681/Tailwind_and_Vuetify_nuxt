          ...
          >
            ...
            <li class="mr-2" role="presentation">
              <button
                ...
                v-bind:class="{
                  'text-gray-600 bg-transparent': openTab !== 2,
            ...
            <li class="mr-2" role="presentation">
              <button
                ...
                v-bind:class="{
                  'text-gray-600 bg-transparent': openTab !== 3,
      ...
      <div v-bind:class="{ hidden: openTab !== 1, block: openTab === 1 }">
        ...
        <div class="grid grid-cols-12 gap-2 py-4">
          ...
          <div class="lg:col-span-4 col-span-12 lg:py-0 py-2">
            <div
              class="grid grid-cols-1 gap-1 divide-y divide-zinc-300 max-h-96 overflow-y-scroll"
            >
              <div v-for="n in 10" :key="n" class="col-span-1 py-2">
                <ListItem />
              </div>
            </div>
          </div>
